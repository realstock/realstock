...
async function main() {
    ...
    const res = await fetch(`https://graph.facebook.com/v21.0/${videoId}?fields=id,comments.summary(total_count),likes.summary(total_count),updated_time&access_token=${pageToken}`);
