...
async function main() {
    ...
    try {
        ...
        console.log(`Fetching basic fields for valid post: ${validPostId}`);
        const url = `https://graph.facebook.com/v19.0/${validPostId}?fields=shares,comments.summary(total_count),likes.summary(total_count)&access_token=${pageInfo.access_token}`;
