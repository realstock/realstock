  ...
  try {
    ...
    const orderRes = await fetch(`${base}/v2/checkout/orders`, {
      ...
      body: JSON.stringify({
        ...
        purchase_units: [
          {
            reference_id: `youtube_post_${propertyId}`,
            amount: {
              currency_code: "BRL",
              value: paymentAmount.toFixed(2),
            },
            description: `RealStock - Publicação no YouTube Shorts (Propriedade ${propertyId})`,
          },
        ],
        application_context: {
          user_action: "PAY_NOW",
    ...
    console.error("PAYPAL CREATE YOUTUBE ORDER ERROR:", error);
