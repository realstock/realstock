  ...
  try {
    ...
    const orderRes = await fetch(`${base}/v2/checkout/orders`, {
      ...
      body: JSON.stringify({
        ...
        purchase_units: [
          {
            reference_id: `youtube_portfolio`,
            amount: {
              currency_code: "BRL",
              value: paymentAmount.toFixed(2),
            },
            description: `RealStock - Publicação de Portfólio no YouTube Shorts`,
          },
        ],
        application_context: {
          user_action: "PAY_NOW",
    ...
    console.error("PAYPAL CREATE PORTFOLIO YOUTUBE ORDER ERROR:", error);
