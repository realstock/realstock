...
export default function AdminLoteFacebookPage() {
  ...
  async function handlePublish() {
    try {
      ...
      setSuccessMsg("Lote de Patrocinados foi publicado com sucesso no Facebook!");
    } catch(err: any) {
    ...
    <main className="min-h-screen bg-slate-950 p-6 md:p-12 text-white">
      <div className="mx-auto max-w-4xl">
        ...
        <p className="mt-2 text-slate-400">
           Esta central dispara a coleção de imóveis diretamente na fila oficial da Página do Facebook da RealStock como Carrossel.
        </p>
        ...
        {!error && !successMsg && (
          <div className="grid md:grid-cols-2 gap-8 mt-8">
            ...
            <div className="rounded-2xl border border-blue-500/30 bg-gradient-to-br from-blue-500/10 to-indigo-500/10 p-6 flex flex-col justify-center text-center">
                 ...
                 <p className="text-sm text-slate-400 mb-6">Como Admin, você insere esse Carrossel na Página do Facebook instantâneamente.</p>
                 ...
                 <button 
                   ...
                   className="btn-primary w-full bg-gradient-to-r py-4 font-bold text-lg rounded-xl from-blue-500 to-indigo-500 border-none">
                     {isPublishing ? "Injetando no Graph API Facebook..." : "Publicar Imediatamente"}
                 </button>
            </div>
          </div>
        )}
