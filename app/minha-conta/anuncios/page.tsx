  ...
  return (
    <main className="min-h-screen bg-slate-950 px-6 py-8 text-white">
      <div className="mx-auto max-w-6xl">
        ...
        {/* 1. IMÓVEIS ANUNCIADOS */}
        {properties.length === 0 ? (
          <div className="mb-8 rounded-2xl border border-white/10 bg-white/5 p-6 text-slate-400">
        ...
        {(() => {
           ...
           return (
             <div className={`mb-8 relative overflow-hidden rounded-2xl border ${isPublishedAny ? 'border-purple-500/40 bg-gradient-to-r from-purple-500/10 to-indigo-500/5' : 'border-pink-500/20 bg-gradient-to-r from-pink-500/5 to-orange-500/5'} p-5 flex flex-col gap-4`}>
               {isPublishedAny && (
