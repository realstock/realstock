...
export default function PortfolioFacebookPage() {
  ...
  async function loadData() {
    try {
      ...
      setPublishedSessions(data.facebookPosts || []);
                 ...
                 <div className="grid grid-cols-2 gap-3">
                    ...
                    >
                       ...
                       <div className="text-[10px] text-slate-500">
                          {publishedSessions.find(s => s.postType === "carousel") ? "✅ Publicado" : "Galeria de Fotos"}
                       </div>
                    </button>
                    <button 
                 ...
                 {properties.map((prop, idx) => {
                    ...
                    return (
                      <div 
                        ...
                        className={`aspect-square rounded-xl bg-slate-900 border-2 overflow-hidden relative cursor-pointer transition ${isSelected ? 'border-blue-500' : 'border-transparent opacity-50 hover:opacity-80'} ${isDisabled ? 'cursor-not-allowed grayscale' : ''}`}
                      >
                  ...
                  <PayPalButtons
                    ...
                    onApprove={async (data) => {
                      ...
                      try {
                        ...
                        setSuccessMsg("Publicação do portfólio realizada com sucesso!");
                      } catch (err: any) {
