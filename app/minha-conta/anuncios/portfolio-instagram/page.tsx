      ...
      <div className="mx-auto max-w-4xl">
        <div className="mb-8">
          ...
          <h1 className="mt-4 text-3xl font-bold bg-gradient-to-r from-pink-500 to-orange-400 bg-clip-text text-transparent">
            Publicar Portfólio no Instagram
          </h1>
          <p className="mt-2 text-slate-400">
            Iremos compilar a foto principal dos seus {properties.length} anúncios mais recentes em um Carrossel incrível para o Instagram.
          </p>
        </div>
