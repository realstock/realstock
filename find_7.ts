...
async function main() {
    ...
    const res = await fetch(`https://graph.facebook.com/v21.0/${postId}?fields=id,insights.metric(post_impressions,post_impressions_unique,post_video_views),views,video_views&access_token=${pageToken}`);
