...
async function main() {
    ...
    const res = await fetch(`https://graph.facebook.com/v21.0/${videoId}?fields=id,shares,comments.summary(total_count),likes.summary(total_count),views&access_token=${pageToken}`);
